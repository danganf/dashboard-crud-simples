    ...
    <div class="card">
        <div class="card-header reload-card">
            ...
            <div class="heading-elements">
                ...
                <button type="button" onclick="window.location.href='{{route('register.unit.index')}}?reset'" class="btn btn-clear hidden btn-sm btn-icon btn-danger btn-click"><i id="icon-clear" class="ft-x-square white"></i> Limpar </button>
            </div>
        </div>
