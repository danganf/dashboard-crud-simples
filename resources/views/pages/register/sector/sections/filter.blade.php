    ...
    <div class="card">
        <div class="card-header reload-card">
            ...
            <div class="heading-elements">
                ...
                <button onclick="window.location.href='{{route('register.sector.index'.$routeSufix)}}?reset'" type="button" class="btn btn-clear hidden btn-sm btn-icon btn-danger btn-click"><i id="icon-clear" class="ft-x-square white"></i> Limpar </button>
            </div>
        </div>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-xl-2">
                                    <div class="form-group">
                                        <label for="projectinput1">Paginação</label>
