    ...
    <div class="card">
        <div class="card-header reload-card">
            ...
            <div class="heading-elements">
                ...
                <button onclick="window.location.href='{{route('register.tag.index'.$routeSufix)}}?reset'" type="button" class="btn btn-clear hidden btn-sm btn-icon btn-danger btn-click"><i id="icon-clear" class="ft-x-square white"></i> Limpar </button>
            </div>
        </div>
